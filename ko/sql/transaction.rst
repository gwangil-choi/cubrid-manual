...
+====================+==========================+=====================+========================================================+
| Not visible        | NULL                     | None 또는           | | 버전이 너무 *최신* 이며 가시적이지 않다.             |
|                    |                          | not visible         | | 행에 이전 버전이 없으므로 무시된다.                  |
|                    +--------------------------+---------------------+--------------------------------------------------------+
|                    | LSA                      | None 또는           | | 버전이 너무 *최신* 이며 가시적이지 않다.             |
|                    |                          | not visible         | | 행에 이전 버전이 있고 스냅샷이  확인해야한다.        |
+--------------------+--------------------------+---------------------+--------------------------------------------------------+
| None or visible    | LSA or NULL              | None 또는           | | 버전이 가시적이며 데이터가 페치(fetch)된다.          |
|                    |                          | not visible         | | 행에 이전 버전이 있는지 여부는 중요하지 않다.        |
|                    |                          +---------------------+--------------------------------------------------------+
