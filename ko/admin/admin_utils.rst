...
.. option:: -i, --interval=SECOND
    ...
    *  :red:`Complex: 통계는 다양한 속성으로 구분 된 작업에 대한 여러 값을 추적한다.`
    ...
    +------------------+------------------------------------------+----------------+-----------------------------------------------------------------------+
    | Page buffer 관련 | Num_data_page_fetches                    | Accumulator    | 가져오기(fetch)한 페이지 개수                                         |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    ...
    +------------------+------------------------------------------+----------------+-----------------------------------------------------------------------+
    | Logs  관련       | Num_log_page_fetches                     | Accumulator    | 가져오기(fetch)한 로그 페이지의 개수                                  |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    ...
    +------------------+------------------------------------------+----------------+-----------------------------------------------------------------------+
    | Index 관현       | Num_btree_inserts                        | Accumulator    | 삽입된 노드의 개수                                                    |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    ...
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_traverse                            | Counter/timer  | B-tree 순회의 수행 기간과 횟수                                        |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_find_unique_traverse                | Counter/timer  | B-tree 'find unique' 순회의 수행 기간과 횟수                          |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_range_search_traverse               | Counter/timer  | B-tree 'range search' 순회의 수행 기간과 횟수                         |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_insert_traverse                     | Counter/timer  | B-tree 'insert' 순회의 수행 기간과 횟수                               |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_delete_traverse                     | Counter/timer  | B-tree 'physical delete' 순회의 수행 기간과 횟수                      |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_mvcc_delete_traverse                | Counter/timer  | B-tree 'mvcc delete' 순회의 수행 기간과 횟수                          |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_mark_delete_traverse                | Counter/timer  | B-tree 'mark delete' 순회의 수행 기간과 횟수                          |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_undo_insert_traverse                | Counter/timer  | B-tree 'undo physical insert' 순회의 수행 기간과 횟수                 |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_undo_delete_traverse                | Counter/timer  | B-tree 'undo physical delete' 순회의 수행 기간과 횟수                 |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_undo_mvcc_delete_traverse           | Counter/timer  | B-tree 'undo delete' 순회의 수행 기간과 횟수                          |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_vacuum_traverse                     | Counter/timer  | B-tree 'vacuum deleted object' 순회의 수행 기간과 횟수                |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    |                  | ..bt_vacuum_insid_traverse               | Counter/timer  | B-tree 'vacuum insert id' 순회의 수행 기간과 횟수                     |
    +------------------+------------------------------------------+----------------+-----------------------------------------------------------------------+
    | Query 관련       | Num_query_selects                        | Accumulator    | SELECT 쿼리의 수행 횟수                                               |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    ...
    +------------------+------------------------------------------+----------------+-----------------------------------------------------------------------+
    | Sort 관련        | Num_sort_io_pages                        | Accumulator    | | 정렬하는 동안 디스크에서 페치한 페이지 개수                         |
    |                  |                                          |                | | (이 값이 클수록 덜 효율적임)                                        |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
    ...
    | 관련             |                                          |                |                                                                       |
    +------------------+------------------------------------------+----------------+-----------------------------------------------------------------------+
    | Heap 관련        | Num_heap_stats_bestspace_entries         | Accumulator    | 최적합 페이지 목록에 저장된 적합 페이지 개수                          |
    |                  +------------------------------------------+----------------+-----------------------------------------------------------------------+
